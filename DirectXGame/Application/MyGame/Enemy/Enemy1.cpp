...
{//移動
	if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_NONE) speed = { 0.0f, 0.0f, -0.2f };
	else if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_ENEMY_POWER) speed = { 0.0f,0.0f,-0.1f };
	else if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_ENEMY_GUARD) speed = { 0.0f,0.0f,-0.2f };
	else if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_ENEMY_SPEED) speed = { 0.0f,0.0f,-0.5f };
	else if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_ENEMY_DEATH) speed = { 0.0f,0.0f,-0.2f };
...
{
	//ライフ
	if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_NONE) life_ = 4;
	else if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_ENEMY_POWER) life_ = 4;
	else if (collider->GetSubAttribute() == SUBCOLLISION_ATTR_ENEMY_GUARD) life_ = 8;
