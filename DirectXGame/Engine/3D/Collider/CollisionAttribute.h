...
const unsigned short SUBCOLLISION_ATTR_GIMMICK_FALLSPHERE = (0b1 << 15) + 101;//乗ると落ちる球(降りても落下したまま)
const unsigned short SUBCOLLISION_ATTR_GIMMICK_FALLSPHERE_UP = (0b1 << 15) + 101;//乗ると落ちる球(降りると元の位置に戻る)
