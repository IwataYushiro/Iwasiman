...
const unsigned short COLLISION_ATTR_EARTH = 0b1 << 6;//地球
...
const unsigned short SUBCOLLISION_ATTR_ENEMY_GUARD = (0b1 << 15) + 201;//攻撃型
const unsigned short SUBCOLLISION_ATTR_ENEMY_SPEED = (0b1 << 15) + 202;//スピード型
const unsigned short SUBCOLLISION_ATTR_ENEMY_DEATH = (0b1 << 15) + 203;//当たると死亡